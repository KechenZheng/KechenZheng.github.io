...
(J20) H. Ge, **<span style="color: blue">K. Zheng</span>**, K. Chi, and X. Liu, The maximal secondary throughput in cognitive wireless networks with energy harvesting, to appear in **IET Communications**, 2022. **(CCF-C)**(Corresponding author)   
...
(J18) Z. Qu, Q. Jia, C. Lyu, J. Liu, X. Liu, and **<span style="color: blue">K. Zheng</span>**, [Detecting fake reviews with generative adversarial networks for mobile social networks](https://www.hindawi.com/journals/scn/2022/1164125/), to appear in **Security and Communication Networks**, Article ID 1164125, 2022. **(CCF-C)**  
