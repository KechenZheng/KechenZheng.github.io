<img src="2.JPG" width="140" height="170"/>  **Kechen Zheng**, Associate Professor (Tenure Track), Master Supervisor  
...
(J16) **<span style="color: blue">K. Zheng</span>**, G. Jiang, X. Liu, K. Chi, X. Yao, and J. Liu, [DRL-based offloading for computation delay minimization in wireless-powered multi-access edge computing](https://ieeexplore.ieee.org/document/10019272), to appear in **IEEE Transactions on Communications**, 2023. **(CCF-B)**  
...
(J20) H. Ge, **<span style="color: blue">K. Zheng\*</span>**, K. Chi, and X. Liu, [The maximal secondary throughput in cognitive wireless networks with energy harvesting](https://ietresearch.onlinelibrary.wiley.com/doi/10.1049/cmu2.12543), to appear in **IET Communications**, 2022. **(CCF-C)**(Corresponding author)   
